...
const CustomModal = React.memo(({message, isOpen, onClose, onSubmit,submitMessage, isInput, placeholder, closeMessage, style, inputStyle, buttonStyle, percent, timeOut}) => {
