...
const Modal = ({message ,setShowModal, callBack}) => {
    ...
    return(
        <div style={{width:'100vw',height:'100vh',display:'flex',justifyContent:'center',alignItems:'center',background:'rgba(0, 0, 0, 0.486)'}}>
            <div style={{height:100,width:200,background:'rgb(192, 216, 255)',borderRadius:10,textAlign:'center'}}>
                ...
                <button style={{padding:10,borderRadius:10,border:'none',margin:5,cursor:'pointer',width:70}}>아니요</button>
                </div>
            </div>
        </div>
    )
